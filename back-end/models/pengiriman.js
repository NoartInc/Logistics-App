...
module.exports = (sequelize, DataTypes) => {
  class Pengiriman extends Model {
    ...
    static associate(models) {
      ...
      // Issue
      models.Pengiriman.belongsTo(models.PengirimanIssue, {
        as: "issue_produksi",
        foreignKey: "productionIssue",
      });

      models.Pengiriman.belongsTo(models.PengirimanIssue, {
        as: "issue_logistic",
        foreignKey: "logisticIssue",
      });
    }
  }
  Pengiriman.init(
    {
      ...
      productionIssue: DataTypes.INTEGER,
      logisticIssue: DataTypes.INTEGER,
      status: {
        type: DataTypes.ENUM(
          "diproses",
          "dimuat",
