...
import { retrievePengangkutans, deletePengangkutan } from '../../store/actions/pengangkutan-action';
          ...
          },
          {
              ...
              Cell: (pengangkutans) => (
                <div className="flex justify-start">
                  ...
                  <svg onClick={() => removePengangkutan(pengangkutans.row.original.id)} xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 text-red-400 cursor-pointer" fill="none"
