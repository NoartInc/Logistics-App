    ...
    const columns = useMemo(
      () => [
          ...
          },
          {
              ...
              accessor: 'fullName',
              Cell: (data) => (
                <a href={`/MasterTeli/TeliProfile/${data.row.original.id}`} className="hover:text-blue-700 font-semibold"> {data.row.original.fullName} </a>
              )
          },
          {
              Header: 'Location',
          ...
          },
          {
              ...
              Cell: (telis) => (
                <div className="flex justify-start">
                  ...
                  <svg onClick={() => removeTeli(telis.row.original.id)} xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 text-red-400 cursor-pointer" fill="none"
