...
function KendaraanModalEditForm({ id = null }) {
  
  const dispatch = useDispatch();
  const [showModal, setShowModal] = useState(false);
  const [form, setForm] = useState({});
  const currentData = useSelector(state => state.kendaraans.selectedData);
