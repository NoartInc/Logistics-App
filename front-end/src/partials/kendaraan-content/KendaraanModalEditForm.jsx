...
function KendaraanModalEditForm() {

    const [showModal, setShowModal] = useState(false);

  return (
    <>
    <svg type="button" onClick={() => setShowModal(true)} xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 text-blue-400 cursor-pointer" fill="none"
...
export default KendaraanModalEditForm