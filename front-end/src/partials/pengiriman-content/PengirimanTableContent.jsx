...
import { changeFilter, changeOffset, changePageSize, changeSearch, retrievePengiriman } from "../../store/actions/pengiriman-action";
import PengirimanModalFilter from "./PengirimanModalFilter";
  ...
  return (
    <span
      className={classNames(
        ...
        status.startsWith("terkirim") ? "bg-gray-400 text-white" : null,
        status.startsWith("pending") ? "bg-yellow-100 text-yellow-800" : null,
        status.startsWith("cancel") ? "bg-red-100 text-red-800" : null
      )}
    >
      {status}
    </span>
...
function PengirimanTableContent({ columns, data }) {
  ...
  const dispatch = useDispatch();
  const { pageCount: lastPage, pageSize: limit, page: dataPage, search, filters } = useSelector(state => state.pengirimans);
  const {
    getTableProps,
    getTableBodyProps,
    headerGroups,
        ...
        <div className="px-4 py-5 bg-white sm:p-6">
          ...
          <div className="sm:flex sm:gap-x-2 py-2 justify-between">
            <div className="flex items-center gap-x-3">
              <PengirimanModalFilter applyFilter={applyFilter} />
              <GlobalFilter
          ...
          {data && data?.length ? (
            ...
            <div className="flex justify-center items-center flex-col border border-gray-200 rounded-lg py-12">
...
export default PengirimanTableContent;
