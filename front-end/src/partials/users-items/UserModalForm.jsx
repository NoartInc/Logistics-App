                  ...
                  <form action="#" method="POST">
                    <div className="grid grid-cols-9 gap-9 px-4 py-4">
                      ...
                      <div className="col-span-9 sm:col-span-3">
                        <label for="fullname" className="block text-sm font-medium uppercase text-gray-500">Fullname<span className="text-red-600">*</span></label>
                      ...
                      <div className="col-span-9 sm:col-span-3">
                        <label for="username" className="block text-sm font-medium uppercase text-gray-500">Username<span className="text-red-600">*</span></label>
                      ...
                      <div className="col-span-9 sm:col-span-3">
                        <label for="password" className="block text-sm font-medium uppercase text-gray-500">Password<span className="text-red-600">*</span></label>
                      ...
                      <div className="col-span-9 sm:col-span-3">
                        <label for="role" className="block text-sm font-medium uppercase text-gray-500">Role<span className="text-red-600">*</span></label>
                      ...
                      <div className="col-span-9 sm:col-span-3">
                        <label for="jabatan" className="block text-sm font-medium uppercase text-gray-500">Jabatan</label>
                      ...
                      <div className="col-span-9 sm:col-span-3">
                        <label for="email" className="block text-sm font-medium uppercase text-gray-500">Email</label>
                      ...
                      <div className="col-span-9 sm:col-span-3">
                        <label for="contact" className="block text-sm font-medium uppercase text-gray-500">Contact<span className="text-red-600">*</span></label>
