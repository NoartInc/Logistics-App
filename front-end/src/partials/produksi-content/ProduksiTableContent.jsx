...
import ProduksiModalForm from "./ProduksiModalForm";
  ...
  return (
    ...
    <div className="shadow overflow-hidden sm:rounded-md">
            ...
            <header className="px-0 mt-0 mb-4">
              <h2 className="font-semibold text-slate-800 uppercase">Operator Produksi List</h2>
            </header>
...
export default ProduksiTableContent