                ...
                <div className="mt-5 md:mt-0 md:col-span-4">
                    ...
                    <div className="grid grid-cols-9 gap-9 px-4 py-4">
                      ...
                      <div className="col-span-9 sm:col-span-3">
                        ...
                        <input onChange={onInputChange} type="text" name="customer" id="customer" className="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"/>
                      </div>

                      <div className="col-span-9 sm:col-span-3">
                        <label for="pic" className="block text-xs font-medium uppercase text-gray-500">PIC<span className="text-red-600">*</span></label>
                        <input onChange={onInputChange} type="text" name="pic" id="pic" className="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"/>
                      </div>
                      ...
                      <div className="col-span-9 sm:col-span-6">
                        <label for="address" className="block text-xs font-medium uppercase text-gray-500">Alamat Customer</label>
                        <textarea onChange={onInputChange} type="text" name="address" id="address"  rows='4' className="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" placeholder='Alamat lengkap customer'/>
                      </div>
