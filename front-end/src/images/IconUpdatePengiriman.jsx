...
const IconUpdatePengiriman = ({ status }) => {
  if (status === "cancel") {
    return (
      <span className="flex absolute -left-3 justify-center items-center w-6 h-6 bg-red-200 rounded-full ring-8 ring-white">
  ...
  if (status === "pending") {
    return (
      <span className="flex absolute -left-3 justify-center items-center w-6 h-6 bg-orange-200 rounded-full ring-8 ring-white">
